...
sed -i "s/$search/$nametguser/gi" bot-1/www/index.html
fi
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
echo -e ""
...
sed -i "s/$search/$tgadmin/gi" bot-1/www/bot/index.php
fi
echo -e ""
...
echo ""
echo ""
echo -e "\033[1;33m the first part of the installation is complete\e[0m'
echo ""
echo -e $'\e[1;34m::TGBA::\e[0m\033[1;90m #Open NEW SESSION in TERMUX enter command: bash ngrok.sh"
echo ""
while true
do
sleep 5
