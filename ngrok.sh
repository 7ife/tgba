...
echo "${k}╚═╝░░╚══╝░╚═════╝░╚═╝░░╚═╝░╚════╝░╚═╝░░╚═╝";
echo ""
echo -e " \033[1;93m To run ngrok and update the address, use this command in termux:\e[0m \033[1;90mngrok http 8080\e[0m"
echo ""
sleep 3
echo -e $'\e[1;34m::TGBA::\e[0m\e[1;32m #Start in 6 seconds\e[0m'
sleep 6
ngrok http 8000